...
public class SandboxConjuntos
{
    ...
    {
    	List<String> listaInvertidaCadenas = new ArrayList<>();
    	for (String cadena : arbolCadenas.descendingSet()) {
    		listaInvertidaCadenas.add(cadena);
    		
    	}
        return listaInvertidaCadenas;
    }
    ...
    {
    	String primeraCadena = arbolCadenas.pollFirst();
    ...
    {
    	String ultimaCadena = arbolCadenas.pollLast();
    ...
    {
    	TreeSet<String> invertidasCadenasArbol = new TreeSet<>(arbolCadenas.descendingSet());
    	return invertidasCadenasArbol;
    }
