...
public class SandboxListas 
{
    ...
    {
    	int cantidadCadenas = listaCadenas.size();
    ...
    public int contarEnterosRepetidos( )
    {
    	...
    	List<Integer> enterosRepetidos = new ArrayList<>();
    	for (Integer entero: listaEnteros) {
    		if (enterosLista.contains(entero)) {
    			enterosLista.remove(entero);
    ...
    public void generarEnteros( int cantidad, int minimo, int maximo )
    {
    	...
    	for(int i =0; i<cantidad; i++) {
    		Integer nuevoValor = random.nextInt(maximo - minimo + 1) + minimo;
